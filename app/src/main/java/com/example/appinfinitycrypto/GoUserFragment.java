 ...
 * Use the {@link GoUserFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class GoUserFragment extends Fragment {

    Button btnGoUser, btnLogout;
    ...
    public static GoUserFragment newInstance(String param1, String param2) {
        GoUserFragment fragment = new GoUserFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_go_user, container, false);

        btnGoUser = view.findViewById(R.id.btnSignInnot);
        ...
        btnGoUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getActivity(), "Successfully Sign In", Toast.LENGTH_SHORT).show();
