...
public interface ApiCoinMarket {
    ...
    @GET("v1/cryptocurrency/listings/latest")
    Call<TopGainer> convertUsdToVndGainer(@Query("CMC_PRO_API_KEY") String CMC_PRO_API_KEY,
                                                 @Query("sort") String sort,
                                                 @Query("start") int start,
                                                 @Query("limit") int limit,
                                                 @Query("cryptocurrency_type") String cryptocurrency_type,
    ...
    @GET("v1/cryptocurrency/listings/latest")
    Call<TopLoser> convertUsdToVndLoser(@Query("CMC_PRO_API_KEY") String CMC_PRO_API_KEY,
                                         @Query("sort") String sort,
